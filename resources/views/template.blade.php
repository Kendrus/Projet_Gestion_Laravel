...
<html lang="en">
	...
	<body>
					...
					<div class="header-profile d-flex align-items-center">
						<div class="dropdown">
							<a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
								...
								<span class="avatar">
									<img src="assets/images/user4.png" alt="Admin Panel" />
				...
				<nav class="sidebar-wrapper">
					...
					<div class="brand">
						<a href="index.html" class="logo">
							<img src="assets/images/logo.svg" class="d-none d-md-block me-4" alt="Ruby Admin Dashboard" />
							<img src="assets/images/logo-sm.svg" class="d-block d-md-none me-4" alt="Ruby Admin Dashboard" />
						</a>
					</div>
					<!-- Sidebar brand ends -->

					<!-- Sidebar quicklinks starts -->
					<div class="sidebar-quick-links">
						<h6 class="fw-light mt-5 mb-3 text-center text-white">
							Quick Links
						</h6>
						<div class="quick-links">
							<a href="profile.html" class="shade-dark" data-bs-toggle="tooltip" data-bs-title="Profile"
								data-bs-custom-class="custom-tooltip-red">
								<i class="bi bi-trophy"></i>
							</a>
							<a href="account-settings.html" class="shade-dark" data-bs-toggle="tooltip" data-bs-title="Settings"
								data-bs-custom-class="custom-tooltip-red">
								<i class="bi bi-nut"></i>
							</a>
							<a href="calendar.html" class="shade-red" data-bs-toggle="tooltip" data-bs-title="Calendar"
								data-bs-custom-class="custom-tooltip-red">
								<i class="bi bi-calendar4"></i>
							</a>
						</div>
					</div>
					<!-- Sidebar quicklinks ends -->
		...
		************* -->
		...
		<script src="assets/vendor/apex/custom/dash1/reports.js"></script>
